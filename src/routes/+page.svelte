	...
	<div class="flex min-h-screen w-full max-w-4xl flex-col items-center py-5">
		...
		>
			...
			>
				...
				<p class="mt-1 lg:w-full lg:text-lg">Jadwal Keberangkatan</p>
			</a>
			<a
				href="/datasantri"
				class="col-span-1 flex h-40 flex-col items-center justify-center gap-3 lg:gap-1 rounded-xl bg-green-300 px-2 py-5 font-semibold uppercase shadow-lg transition-transform duration-200 hover:scale-105"
			>
